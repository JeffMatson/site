...
For some reason, I tend to think about everything in the world as a compiled set of components, just begging to be dissected. Maybe it's the ADHD. Maybe it's the OCD. Whatever it is, it creates an endless list of hobbies.
