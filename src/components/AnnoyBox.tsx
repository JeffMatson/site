...
interface AnnoyBox {
    Container: FunctionComponent<{isConfirmation: boolean, position: PositionCoordinates, children: ReactElement}>,
    Content: FunctionComponent<{styles: CSSModuleClasses, children: ReactElement}>,
    Header: FunctionComponent<{styles: CSSModuleClasses, children: ReactElement}>,
    ButtonContainer: FunctionComponent<{children: ReactElement}>,
    Button: FunctionComponent<{action: (id: string) => void, AnnoyBoxId: string, title: string }>
}
...
const AnnoyBox: AnnoyBox = {
    ...
    Button: ({action, AnnoyBoxId, title}) => {
        ...
        return (
            <button onClick={() => buttonAction(AnnoyBoxId)}>{title}</button>
        );
    }
};
